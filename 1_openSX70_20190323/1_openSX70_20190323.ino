//THIS IS ONLY FOR EXPERIMENTAL REWORKED ALPHA-2 PCBS WITH AD654 AND S2 CONNECTED TO A4, led2 TO A5 and counter on input 5 (OLD led 2)
//ALSO FLASH ON 3.3V (ALL RUNNING AT 3.3V).
//DONGLE SHOULD WITHOUT LDO 2.8V
