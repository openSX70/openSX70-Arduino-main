...
//                            if ((Read_DS2408_PIO(0) < 100) || (Read_DS2408_PIO(0) == 200))  //THIS CASE WE HAVE A PROPER SHUTTER SPEED
...
*/
                            if ((ShutterSpeed[Read_DS2408_PIO(0)] == (AUTO100)) && (progressPicture == false))
                            {
                            ...
                            if ((ShutterSpeed[Read_DS2408_PIO(0)] == (AUTO600))&& (progressPicture == false))
                            {
                              output_compare = 210; //OPTION magic number for ISO 600
                               Serial.println ("A6");
                              AutoExposure();
                              return;
                            }
...
//          Dongle (Read_DS2408_PIO(0));
  ...
  if (Read_DS2408_PIO(0) == 200)  //THIS CASE WILL BE AUTO PROBABLY AT 600ASA
  {
    Serial.println ("200");
                                  ...
                                  //  #if ISDEBUG 
                                    Serial.print ("AQUIIIIIIIIIIIIIIIIIIIIIIIIII");
