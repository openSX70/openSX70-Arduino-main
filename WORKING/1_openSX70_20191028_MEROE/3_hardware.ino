...
//
#define SONAR 0 //this is for SONAR cameras
...
//MEROË TCS3200 100% SETTINGS
//const int OE_Pin = 9;
/////int A600 = 450;
//int A600 = 400; //initial TCS3200 magic Number
int A600 = 300; //initial TCS3200 magic Number

//int A100 = 1000;
//int A100 = 950; //initial TCS3200 magic Number
int A100 = 800; //initial TCS3200 magic Number
#endif
