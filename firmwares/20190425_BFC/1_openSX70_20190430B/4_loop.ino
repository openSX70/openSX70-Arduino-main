...
unsigned long exposure = frequencyCounter();
...
//+ ShutterConstant;
  ...
  int top = ShutterSpeedDelay * 2;
  int under = ShutterSpeedDelay / 2;
  ...
  {
    if ((ShutterSpeed[selector]< top) && (ShutterSpeed[selector]> under))
